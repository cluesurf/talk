 ...
 * Talk Tokenizer
 *
 * Parses a Talk notation string into structured tokens.
 * Each token is a consonant, vowel, symbol, numeral, or space
 * with its features/flags parsed into typed fields.
 *
 * Usage:
 *   import { tokenize } from '@cluesurf/talk/make/tokenizer'
