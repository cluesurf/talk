...
Conversion runs in both directions. \verb|talk_to_ipa| reads a talk string and returns IPA. \verb|ipa_to_talk| reads IPA and returns talk. The talk direction is the canonical one, so a talk spelling converted to IPA and back returns the same spelling. The IPA direction is many to one, since several fine IPA symbols map to the same talk sound, which is the ninety-five percent choice made concrete.
